...
<div class="max-w-7xl mx-auto mt-10 bg-white p-6 rounded shadow">
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('admin.student.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">+ Tambah Siswa</a>
    </div>
        ...
        <table class="min-w-full border text-sm text-gray-800">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-4 py-2">{{ $student->nis }}</td>  <!-- Menampilkan NIS -->
                    <td class="px-4 py-2">{{ $student->kelas }}</td>  <!-- Menampilkan Kelas -->
                    <td class="px-4 py-2">{{ $student->jurusan }}</td>  <!-- Menampilkan Jurusan -->
                    <td class="px-4 py-2">
                        {{ $student->schoolYear ? $student->schoolYear->tahun : 'Tahun Ajaran Tidak Tersedia' }}
                    </td>  <!-- Menampilkan Tahun Ajaran dengan relasi -->
                    <td class="px-4 py-2">
