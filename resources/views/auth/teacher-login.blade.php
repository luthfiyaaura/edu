...
<head>
    <meta charset="UTF-8">
    <title>Login Guru | EduMajor</title>
...
<body class="min-h-screen flex text-gray-800">
    ...
    <!-- Sidebar Kiri -->
    <div class="w-1/2 bg-green-600 text-white p-10 flex flex-col justify-center">
        <div class="max-w-md mx-auto text-center">
            <img src="{{ asset('logo.png') }}" class="h-24 mx-auto mb-6" alt="Logo Sekolah">
            <h1 class="text-3xl font-bold mb-2">Login Guru</h1>
            {{-- <p class="text-sm">Login untuk Guru BK agar dapat memantau hasil tes minat bakat siswa dan memberikan rekomendasi jurusan di SMKN 14 Jakarta.</p> --}}
        </div>
    </div>
    ...
    <div class="w-1/2 relative flex items-center justify-center p-10 bg-silhouette">
        ...
        <div class="relative z-10 max-w-md w-full">
            <h2 class="text-2xl font-semibold mb-6 text-center text-gray-800">Masuk Sebagai Guru</h2>
